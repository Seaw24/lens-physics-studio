# Lens — see a moment, keep the understanding

Lens is a physics learning prototype for students who can remember a formula but struggle to recognize when it applies. It connects an ordinary video to their course through a focused coaching experience.
...
Lens makes the context, question, and explanation visible together. A student can inspect the moment, test a misconception, and leave with an idea they can describe—not simply a formula they have seen.
